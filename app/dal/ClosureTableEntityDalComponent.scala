 ...
 * @since 27.9.2013 
 */
trait ClosureTableEntityDalComponent extends EntityDalComponent {

  val driver: ExtendedProfile
  def entityDal: EntityDal = new ClosureTableEntityDal(driver)

  class ClosureTableEntityDal(val driver: ExtendedProfile) extends EntityDal {
    ...
    override def addEntity(entity: Entity, parentId:Long = -1) = {
    ...
    override def getEntity(id:Long) = {
    ...
    override def getEntityHierarchy(root:Long, maxDepth:Int = Int.MaxValue) = {
    ...
    override def updateEntity(nodeId:Long, entity:Entity) {
    ...
    override def deleteEntity(nodeId:Long) {
    ...
    override def moveNode(nodeId:Long, targetId:Long) {
